...
#  4-Global cluster coefficient
  v4_all=GlobalClusterCoefficientQuaternion(data)
  v4_agroup,v4_bgroup=GlobalClusterCoefficient(data)
  tuple4=(ID,"Global cluster coefficient",v4_all,v4_agroup,v4_bgroup)
  push!(df,tuple4)
...
"""
function NullNetworkLevel(data::DataFrame;num=100,fun="Null2",coinpvalue=0.5)
#  计算原始二分网络的属性
  df=NetworkLevel(data,"original")
#  生成二分网络零模型并计算
  for i in 1:num
